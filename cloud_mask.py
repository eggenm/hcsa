...
## INTEGRATE UPADTED CLOUD MASK FOR NEW LANDSAT 8 SR PROUDCT
## TODO: in strata_classification remove the local functions and replace
## with call to this package once ls8 is integrated
